...
REPORT_TEMPLATES = [
    {
        ...
        "schema_json": [
            ...
            {"type": "timeline", "filter": {"entry_type": "containment"}, "max_entries": 10},
    ...
    },
    {
        ...
        "schema_json": [
            ...
            {"type": "timeline", "filter": {}, "max_entries": 500},
            {"type": "section", "title": "Indicators of Compromise"},
            {"type": "ioc_table", "filter": {}, "columns": ["type", "value", "confidence", "status", "tlp_level"]},
    ...
    },
    {
        ...
        "schema_json": [
            ...
            {"type": "timeline", "filter": {"entry_type": "detection"}, "max_entries": 50},
            {"type": "section", "title": "Response Timeline"},
            {"type": "timeline", "filter": {"entry_type": "containment"}, "max_entries": 50},
